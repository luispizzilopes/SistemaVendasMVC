...
namespace Sistema_Vendas.Controllers
{
    ...
    {
        private readonly Sistema_VendasContext _context;

        public DepartamentosController(Sistema_VendasContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Sistema_VendasContext.Departamento'  is null.");
            }
            var departamento = await _context.Departamento.FindAsync(id);
            if (departamento != null)
            {
